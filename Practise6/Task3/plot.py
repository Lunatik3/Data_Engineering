...
plt.plot(dataset.groupby(["AIRLINE"])['TAXI_IN'].sum().values, marker='o', linestyle='-')
...
data_for_pie = dataset['AIRLINE'].value_counts()
...
plt.figure(figsize=(8, 6))
sns.boxplot(x='DAY_OF_WEEK', y='TAXI_IN', data=dataset)
plt.title('Boxplot')
plt.xlabel('DAY_OF_WEEK')
plt.ylabel('TAXI_IN')
